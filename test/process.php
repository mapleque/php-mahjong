...
assert($set_info);
echo "\n";
assert($set_info['log_info'][0]['ops'][0] === OP_INIT);
echo "\n";
echo '****************************************';
echo "\n";
echo 'starat OK ';
...
echo "\n";
assert($set_info['log_info'][0]['ops'][0] === OP_GET);
echo '****************************************';
echo "\n";
echo 'init OK ';
echo "\n";
...
dump($set_info['log_info'][0]['ops']);
echo "\n";
assert($set_info['log_info'][0]['ops'][0] === OP_PUSH);
echo 'cur seq ';
...
echo 'user push ';
echo "\n";
assert(Set::op($user_id, OP_PUSH, [10]));
echo 'hand card ';
$set_info = Set::getSetInfo($user_id);
dump_card($set_info['log_info'][0]['hand']);
echo "\n";
